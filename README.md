*BWGL* is a small, header only C++ rendering framework built on **OpenGL** 4.4, which provides abstractions for common tasks such as window handling, shader and texture caching, camera system and model loading.
<br/> <br/>
...
- Just obj file support for loading meshes
